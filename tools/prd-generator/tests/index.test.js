...
describe('PRD Generator Tool Executor', () => {
    ...
    it('should correctly assemble prompts, call dependencies, format result, and save file on success', async () => {
        ...
        expect(mockPerformResearchQuery).toHaveBeenCalledWith(expect.stringContaining(`Market analysis and competitive landscape for: ${productDescription}`), mockConfig);
        expect(mockPerformResearchQuery).toHaveBeenCalledWith(expect.stringContaining(`User needs, demographics, and expectations for: ${productDescription}`), mockConfig);
        expect(mockPerformResearchQuery).toHaveBeenCalledWith(expect.stringContaining(`Industry standards, best practices, and common feature sets for products like: ${productDescription}`), mockConfig);
