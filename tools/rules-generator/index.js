 ...
 */
export const generateRules = async (params, // More type-safe than 'any'
config) => {
    ...
    try {
        ...
        const rulesMarkdown = await performDirectLlmCall(mainGenerationPrompt, RULES_SYSTEM_PROMPT, // Pass the system prompt
        config, 'rules_generation', // Logical task name
