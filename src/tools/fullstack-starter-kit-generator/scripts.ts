 ...
 */
export function generateSetupScripts(definition: StarterKitDefinition): ScriptOutput {
  ...
  function processStructure(items: StarterKitDefinition['directoryStructure'], currentPathSh: string, currentPathBat: string) {
    items.forEach(item => {
