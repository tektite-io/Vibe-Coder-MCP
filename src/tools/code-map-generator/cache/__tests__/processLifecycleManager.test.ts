...
describe('ProcessLifecycleManager', () => {
  ...
  it('should handle degraded memory', () => {
    // Mock getMemoryStats to return high memory usage
    vi.mocked(require('../../parser.js').getMemoryStats).mockReturnValueOnce({
      heapUsed: 160000000,
      heapTotal: 200000000,
      rss: 180000000,
      systemTotal: 1000000000,
  ...
  it('should handle critical memory', () => {
